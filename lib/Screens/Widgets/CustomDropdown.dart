...
Widget dropdownButtonChooseCurrency(
  ...
  ? currentState.chosenCurrency.currency
      ...
      Container(
        padding: EdgeInsets.only(top: 16),
          child: check ? SvgPicture.asset('assets/images/ic_${currentState.chosenCurrency.currency}.svg', height: 16, width: 16,)
              : SvgPicture.asset('assets/images/ic_VND.svg', height: 16, width: 16,),),],
  );
}
